    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          SizedBox(height: 50,),
          SafeArea(child: FlatButton(child: Text('Forgot password'), onPressed: (){
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage = 'Password is very weak';
      ...
      const errorMessage = 'Could Not Aunthenticate You, Please try again';
      _showErrorDialog(errorMessage);
    }
    setState(() {
      _isLoading = false;
